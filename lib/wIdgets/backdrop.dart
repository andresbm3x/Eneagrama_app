...
class _BackdropTitle extends AnimatedWidget {
  ...
  static const Widget _defTitle=Text("title");

  const _BackdropTitle({
    Key key,
    Listenable listenable,
    this.frontTitle=_defTitle,
    this.backTitle=_defTitle,
...
class _BackdropState extends State<Backdrop>
  ...
  void didUpdateWidget(Backdrop old) {
    ...
    if (widget.menuOption != old.menuOption) {
      setState(() {
        _controller.fling(
            velocity:
        ...
        children: <Widget>[
          ...
          PositionedTransition(
            ...
            child: _BackdropPanel(
              ...
              title: new Text("Front",style: TextStyle(color: Colors.transparent),),//widget.frontTitle,
              child: new TestPage()//widget.frontPanel,
            ),
          ),
        ],
      ),
